...
if Rails.env.development?
  ...
  User.create!(email: 'admin_user@example.com', password: 'password', password_confirmation: 'password',
               organization_id: organization.id, role: 1)
  user_1 = User.create!(email: 'user_1@example.com', password: 'password', password_confirmation: 'password',
                        organization_id: organization.id, role: 0)
